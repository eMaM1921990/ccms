...
<tr><td colspan="2"><hr/></td></tr>
<tr>
<td>Area:</td><td><input type="hidden" id="area" name="area" value="">
...
<tr><td colspan="2"><hr/></td></tr>
<td>Status:</td>
<td><input type="hidden" id="status" name="status" value="">
<select name="statusList" id="statusList" onchange="document.getElementById('status').value=this.options[selectedIndex].value;">
<option value=""></option>
 <%
