...
function handle_clear(){
 ...
 document.getElementById("equipmentBox").value="";
 ...
 <link rel="stylesheet" type="text/css" href="ccms.css?v=1" />
</head>
<body>
<%
  String strAreaPara=request.getParameter("area")==null?"":request.getParameter("area");
...
<form name="the_form" id="the_form" method="post" action="">
 ...
 <div class="title"> List of Change Requests</div>
 

<div style="margin-top:20px; padding-top:5px;padding-bottom:5px; width:400px;background-color:#CCCCCC">
<%
  if (requestPage<=0)
//	out.println("Prev");
...
//     out.println("<a href=\"#\" onclick=\"document.getElementById('action').value='prev'; document.the_form.submit();\">Prev</a>");
       out.println("<span style='width:30px'><img src='images/left.gif' alt='Prev' onclick=\"document.getElementById('action').value='prev'; document.the_form.submit();\"/></span>");
...
//	  out.println("Next");
	 ...
	 // out.println("<a href=\"#\" onclick=\"document.getElementById('action').value='next'; document.the_form.submit();\">Next</a>");
      out.println("<span style='width:30px'><img src='images/right.gif' alt='Next' onclick=\"document.getElementById('action').value='next'; document.the_form.submit();\"/></span>");
...
<div>
  ...
  <th style="vertical-align:top;"><div style="width:100px"><a href="javascript:handleOrder('requestDate')">Creation Date</a>
...
<!--	   <input style="width:100px;height:20px" type="text" name="lineBox" id="lineBox" value="<%=strLineBox%>">-->
	   	 <script  type="text/javascript">
	  newCombo("lineBox","lineBox",100,"<%=strLineBox%>","",120,180,lineNameArray);
     </script>
	 </div>
...
<!--	   <input style="width:100px;height:20px" type="text" name="lineBox" id="lineBox" value="<%=strLineBox%>">-->
   ...
   <th  nowrap style="vertical-align:top;width:80px"><a href="javascript:handleOrder('approvalStatus')">Status</a>
	  ...
	  if(j >= requestPage * pageSize && j < (requestPage + 1) * pageSize) {
		  %>
            <tr class="<%=strClass%>" height='30'>
             ...
             <td><div class="cellNowrapHidden" style="width:100px"><%=strCreationDate_t%></div></td>
